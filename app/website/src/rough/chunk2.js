(this["webpackJsonprevieve-web-plugin-4"] = this["webpackJsonprevieve-web-plugin-4"] || []).push([[3], {
    733: function(t, n, i) {
        var e;
        !function() {
            function o(t, n, i) {
            ...
            function B(t, n, i, e, o, a, s) {
                this.v = t,
                    ...
                    t = P(t = new x(this.a.c + ",serif",k(this.a))),
                    this.g.a.style.cssText = t,
                    t = P(t = new x(this.a.c + ",sans-serif",k(this.a))),
                    this.h.a.style.cssText = t,
                    t = P(t = new x("serif",k(this.a))),
                    this.j.a.style.cssText = t,
                    t = P(t = new x("sans-serif",k(this.a))),
            ...
            function q(t) {
                ...
                (n = i === t.f.serif && e === t.f["sans-serif"]) || (n = D() && $(t, i, e)),
                    n ? r() - t.A >= t.w ? D() && $(t, i, e) && (null === t.u || t.u.hasOwnProperty(t.a.c)) ? H(t, t.v) : H(t, t.B) : function(t) {
                        ...
                        if (0 === i.length && a)
                            ...
                            for (c = 0; c < i.length; c++) {
                                var h = i[c]
                                    ...
                                    , u = n.a
                                    , g = h;
                                if (u.g && p(u.f, [u.a.c("wf", g.c, k(g).toString(), "loading")]),
                                    N(u, "fontloading", g),
                                    u = null,
                                null === M)
                                    if (window.FontFace) {
                                        ...
                                        M = !1;
                                u = M ? new W(s(n.g, n),s(n.h, n),n.c,h,n.s,l) : new B(s(n.g, n),s(n.h, n),n.c,h,n.s,t,l),
                                    f.push(u)
                            }
            ...
            J.prototype.g = function(t) {
                var n = this.a;
                n.g && p(n.f, [n.a.c("wf", t.c, k(t).toString(), "active")], [n.a.c("wf", t.c, k(t).toString(), "loading"), n.a.c("wf", t.c, k(t).toString(), "inactive")]),
                    N(n, "fontactive", t),
                    this.m = !0,
                    z(this)
            }
                            ...
                            if (o)
                                for (var r = 0; r < o.length; r++) {
                                    ...
                                    void 0 != o[r].fontStyle && void 0 != o[r].fontWeight ? (i = o[r].fontStyle + o[r].fontWeight,
                                        s.push(new x(c,i))) : s.push(new x(c))
                                }
                            t(s)
                        } else
                            setTimeout((function() {
                ...
                U.prototype.load = function(t) {
                    var n, i, e = this.a.urls || [], o = this.a.families || [], a = this.a.testStrings || {}, s = new m;
                    for (n = 0,
                             i = e.length; n < i; n++)
                        d(this.c, e[n], w(s));
                    var r = [];
                        ...
                        if (2 <= e.length) {
                            ...
                            if (s = [],
                                ...
                                for (var r, c = (r = r.split(",")).length, f = 0; f < c; f++) {
                                    var h;
                                    if ((h = r[f]).match(/^[\w-]+$/))
                                        if (null == (l = nt.exec(h.toLowerCase())))
                                            h = "";
                                        else {
                                            if (h = null == (h = l[2]) || "" == h ? "n" : tt[h],
                                            null == (l = l[1]) || "" == l)
                                                l = "4";
                                            else
                            ...
                            0 < s.length && (a = s),
                            3 == e.length && (s = [],
                            0 < (e = (e = e[2]) ? e.split(",") : s).length && (e = Y[e[0]]) && (t.c[o] = e))
                        }
                        for (t.c[o] || (e = Y[o]) && (t.c[o] = e),
                                 e = 0; e < a.length; e += 1)
                            t.a.push(new x(o,a[e]))
                    }
                }(a),
                    d(i, function(t) {
                        if (0 == t.a.length)
    ...
    734: function(t, n, i) {
        ...
        var e = i(17)
            , o = i(733)
            , a = []
            , s = "https://fonts.googleapis.com/css2"
            , r = function(t) {
            return "".concat(t.replace(" ", "+")).concat(":wght@400;700")
        }
            , c = function(t) {
            var n = t.fonts
                , i = t.css
                , c = null === n || void 0 === n ? void 0 : n.filter((function(t) {
                    var n = t.family;
                    return !a.includes(n)
                }
            ));
            if (null === c || void 0 === c ? void 0 : c.length) {
                var f = function(t, n) {
                    var i, o, c = t.reduce((function(t, n) {
                            var i = n.family
                                , e = n.provider;
                            return a.includes(i) || (a.push(i),
                                t[e].push(i)),
                                t
                        }
                    ), {
                        google: [],
                        custom: []
                    }), f = c.google, h = c.custom, l = {};
                    return 1 === f.length ? l.google = {
                        api: s,
                        families: f.map((function(t) {
                                return "".concat(r(t), "&display=swap")
                            }
                        ))
                    } : f.length > 1 && (l.custom = {
                        urls: ["".concat(s, "?").concat(f.map((function(t) {
                                return "family=".concat(r(t))
                            }
                        )).join("&"), "&display=swap")],
                        families: f
                    }),
                    n && h.length && (l.custom ? (null === (i = l.custom.urls) || void 0 === i || i.push(n),
                    null === (o = l.custom.families) || void 0 === o || o.push.apply(o, Object(e.a)(h))) : l.custom = {
                        urls: [n],
                        families: h
                    }),
                        l
